...
const EXPRESSION_JSON_PATH: String = "res://addons/dialogue_manager/scripts/character/character_expression.json"
const SPEAK_AUDIO_STREAM: AudioStream = preload("speaking.wav")
