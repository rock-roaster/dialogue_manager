...
const DIALOGUE_BUBBLE_VOICE: StyleBoxDialogVoice = preload("stylebox_dialog_voice.tres")
const DIALOGUE_BUBBLE_SPEAK: StyleBoxDialogSpeak = preload("stylebox_dialog_speak.tres")
